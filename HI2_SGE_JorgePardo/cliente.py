...
def cliente():
    ...
    atras = PhotoImage(file="./recursos/factura.png")
    atras = atras.subsample(5,5)
    ...
    lista_registros.heading("Apellido", text="Apellido")
    lista_registros.heading("Telefono", text="Telefono")
    lista_registros.heading("Direccion", text="Direccion")
    lista_registros.heading("Correo", text="Correo")
