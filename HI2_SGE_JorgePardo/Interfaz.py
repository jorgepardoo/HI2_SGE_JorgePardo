...
# Añadimos los botones y sus respectivas posiciones
...
botonGuardar = tk.Button(VentanaPrincipal, width=100, height=100, image=excel, command=exportar_excel)#Clientes
